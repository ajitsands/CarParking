...
import { QrCode, CheckCircle2, AlertCircle, Scan, Camera } from 'lucide-react';
import { api } from '../../services/api';
import VisualVehiclePickerModal from './VisualVehiclePickerModal';
        ...
        <form onSubmit={handleValidate}>
          ...
          <div className="form-group">
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '4px' }}>
              <label className="form-label" style={{ margin: 0 }}>Vehicle Plate Number (Optional)</label>
              <button
                type="button"

    ...
    public function downloadLauncher(): void {
        ...
        if ($type === 'stop') {
            ...
            $content = "@echo off\r\n"
                ...
                . "powershell -NoProfile -Command \"Start-Process php -ArgumentList '-S 0.0.0.0:{$backendPort} backend/public/index.php' -WorkingDirectory '%ROOT_DIR%' -WindowStyle Hidden\" >nul 2>&1\r\n"
                ...
                . "powershell -NoProfile -Command \"Start-Process cmd.exe -ArgumentList '/c npm run dev -- --host 0.0.0.0 --port {$frontendPort}' -WorkingDirectory '%ROOT_DIR%\\frontend' -WindowStyle Hidden\" >nul 2>&1\r\n"
